...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=1000&color=00C9FF&center=true&vCenter=true&multiline=false&width=600&height=50&lines=Full-Stack+Developer;AI+Solutions+Architect;Oracle+Certified+Java+SE+11+Dev;Building+Scalable+Web+Applications" alt="Typing SVG" />
</a>
...
- Passionate about building robust web applications and architecting **AI-driven solutions**
- Deep expertise in **Retrieval-Augmented Generation (RAG)**, **Large Language Models (LLMs)**, **real-time systems**, and **cloud-native architectures**
...
|---------|------|-------------|
| [**RAG From Scratch**](https://github.com/Dhruv-Gupta01/rag-from-scratch) | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![ChromaDB](https://img.shields.io/badge/ChromaDB-FF4F00?style=flat-square) ![Groq LLaMA](https://img.shields.io/badge/Groq_LLaMA-F55036?style=flat-square) | A complete RAG pipeline built entirely from scratch without abstractions. Features hybrid search (BM25 + Semantic), cross-encoder reranking, and contextual retrieval. |
